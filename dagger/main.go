...
func (m *Nobuffer) BaseEnv(source *dagger.Directory) *dagger.Container {
...
func (m *Nobuffer) InstallLua(base *dagger.Container) *dagger.Container {
   return base.
   	WithExec([]string{
   		"apk", "add", "--no-cache",
...
func (m *Nobuffer) InstallLuarocks(base *dagger.Container) *dagger.Container {
   return base.
   	WithExec([]string{
...
func (m *Nobuffer) InstallLuaDependencies(base *dagger.Container) *dagger.Container {
   return base.
