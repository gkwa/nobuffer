...
import (
	...
	"github.com/gkwa/nobuffer/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.nobuffer.yaml)")
